...
#define PIKACHU_SP_DEF (P_UPDATED_STATS >= GEN_6 || P_UPDATED_STATS == GEN_1 ? 50 : 40)
        ...
        [SPECIES_PIKACHU_DETECTIVE]   =
    {
        ...
        .trainerScale = 256,
        .trainerOffset = 0,
        .frontPic = gMonFrontPic_PikachuDetective,
        .frontPicSize = MON_COORDS_SIZE(48, 48),
        .frontPicYOffset = 9,
        .frontAnimFrames = sAnims_SingleFramePlaceHolder,
        //.frontAnimId = ANIM_V_SQUISH_AND_BOUNCE,
        .backPic = gMonBackPic_PikachuDetective,
        .backPicSize = MON_COORDS_SIZE(64, 56),
        .backPicYOffset = 4,
        //.backAnimId = BACK_ANIM_NONE,
        .palette = gMonPalette_PikachuDetective,
        .shinyPalette = gMonShinyPalette_PikachuDetective,
        .iconSprite = gMonIcon_PikachuDetective,
        .iconPalIndex = 2,
        .pokemonJumpType = PKMN_JUMP_TYPE_NORMAL,
        SHADOW(-3, 5, SHADOW_SIZE_M)
        FOOTPRINT(Pikachu)
...
#define EEVEE_SP_ATK (P_UPDATED_STATS >= GEN_2 ? 45 : 65)
    ...
    [SPECIES_EEVEE] =
    {
        ...
        .evolutions = EVOLUTION({EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                                ...
                                {EVO_ITEM, ITEM_SUN_STONE, SPECIES_SUNEON}
                            ...
                            #endif
                            #if P_GEN_4_CROSS_EVOS
                                ,{EVO_LEVEL, 0, SPECIES_LEAFEON, CONDITIONS({IF_IN_MAP, MAP_LEAFON_EVOLVE})},
