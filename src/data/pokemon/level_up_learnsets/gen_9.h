...
#if P_FAMILY_SUNEON
static const struct LevelUpMove sSuneonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_GUST), //x
    LEVEL_UP_MOVE( 1, MOVE_HELPING_HAND), //x
    LEVEL_UP_MOVE( 5, MOVE_SAND_ATTACK), //x
    LEVEL_UP_MOVE(11, MOVE_TAIL_WHIP),
    LEVEL_UP_MOVE(16, MOVE_QUICK_ATTACK), //x
    LEVEL_UP_MOVE(22, MOVE_CHATTER), //x
    LEVEL_UP_MOVE(33, MOVE_MORNING_SUN), //x
    LEVEL_UP_MOVE(44, MOVE_AEROBLAST), //x
    LEVEL_UP_MOVE(55, MOVE_SOLAR_BEAM), //x
...
#if P_FAMILY_I3C_AND
static const struct LevelUpMove sI3cAndLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE( 4, MOVE_THUNDER_SHOCK),
    LEVEL_UP_MOVE( 8, MOVE_CHARGE),
...
static const struct LevelUpMove sI3cNandLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_LEER),
    LEVEL_UP_MOVE( 1, MOVE_QUICK_ATTACK),
    LEVEL_UP_MOVE( 4, MOVE_THUNDER_SHOCK),
    LEVEL_UP_MOVE( 8, MOVE_CHARGE),
