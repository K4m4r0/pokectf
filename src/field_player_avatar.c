    ...
    if (FlagGet(FLAG_SYS_USE_STRENGTH))
    {
        ...
        if (objectEventId != OBJECT_EVENTS_COUNT
         && (gObjectEvents[objectEventId].graphicsId == OBJ_EVENT_GFX_PUSHABLE_BOULDER
          || gObjectEvents[objectEventId].graphicsId == OBJ_EVENT_GFX_MOVING_BOX
          || gObjectEvents[objectEventId].graphicsId == OBJ_EVENT_GFX_CD
          || gObjectEvents[objectEventId].graphicsId == OBJ_EVENT_GFX_BIG_CHARIZARD_DOLL))
        {
