...
const u8 gText_ThisIsAPokemon[] = _("This is a special CTF-Terminal.{PAUSE 96}\p");
...
const u8 gText_BirchInTrouble[] = _("Choose one of those Pokémon!");
...
const u8 gText_GameBoyCart[] = _("The GameBoy Cartridge\n has NOTE and INSPECT\n written on it.\p The Cartridge shows an\n emerald-like Pokémon{PAUSE_UNTIL_PRESS}");
